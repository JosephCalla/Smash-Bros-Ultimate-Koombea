...
protocol OnboardingUIDelegate {
    func uiDidSelect(object: Onboarding)
}

class OnboardingUI : UIView {
    var delegate: OnboardingUIDelegate!
    
    var object : Onboarding?
    var cellIdentifier = "OnboardingCellId"
...
extension OnboardingUI: UITableViewDataSource {
...
extension OnboardingUI: UITableViewDelegate {
