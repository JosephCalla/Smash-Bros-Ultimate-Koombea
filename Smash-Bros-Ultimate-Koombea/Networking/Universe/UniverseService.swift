...
protocol UniverseServiceProtocol{
    func getUniverse(request: UniverserRequest, completion: @escaping ([UniverseResponse]?, Error?) -> Void)
}

class UniverseService: UniverseServiceProtocol {
    
    func getUniverse(request: UniverserRequest,
                     completion: @escaping ([UniverseResponse]?, Error?) -> Void) {
