...
protocol DetailFighterUIDelegate {
    func uiDidSelect(object: DetailFighter)
}

class DetailFighterUI : UIView {
    var delegate: DetailFighterUIDelegate!
    
    var object : DetailFighter?
    var cellIdentifier = "DetailFighterCellId"
...
extension DetailFighterUI: UITableViewDataSource {
...
extension DetailFighterUI: UITableViewDelegate {
